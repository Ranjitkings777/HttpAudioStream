package com.example.dell.http_audio_stream;
...
public class Http_Audio_Stream extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_http__audio__stream);

        // Get the application context
        mContext = getApplicationContext();
        mActivity = Http_Audio_Stream.this;
        ...
        mButtonPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String audioUrl = "http://beta.nurture.co.in/Hesaru_Poorthi.mp3";
